...
It seems that most organisations are currently focusing on implementing open science practices, which is a slow process, and that aligning research metrics with this new approach will come further down the track. This is demonstrated by the [European University Association Open Science Survey 2020-21](https://www.eua.eu/downloads/publications/academic%20assessment%20follow-up%20report.pdf) (EUA), which has found 34% of the surveyed institutions did not report using any open science elements in their academic assessments.  
